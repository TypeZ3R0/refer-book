...
export const sendVerificationEmail = (createdUserEmail, emailToken) => {
    ...
    let mailOptions = {
        ...
        html: `<p>Please click this link to verify your email<p><br><a href=http://localhost:8000/accounts/verify/${emailToken}>Click this link to verify yourself</a>`,
    };
